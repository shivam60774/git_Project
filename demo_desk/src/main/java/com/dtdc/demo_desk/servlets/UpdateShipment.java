...
public class UpdateShipment extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//Instead of new shipment i want the same previous shipment to get updated
		//add a hidden field to html and then set its value to previous tracking number and then use it in catch block to find and merge the data
